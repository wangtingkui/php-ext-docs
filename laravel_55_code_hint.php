 ...
 * Generated for Laravel 5.5.44 on 2019-09-09 13:35:12.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Log {
        ...
        {
                        /** @var \Newhouse\Log\Logger $instance */
         ...
         * @static 
         */ 
        public static function serverLog($level, $message, $context = array())
        {
                        /** @var \Newhouse\Log\Logger $instance */
                        return $instance->serverLog($level, $message, $context);
        }
         ...
         * @static 
         */ 
        public static function sqlLog($level, $message, $context = array())
        {
                        /** @var \Newhouse\Log\Logger $instance */
                        return $instance->sqlLog($level, $message, $context);
        }
         ...
         * @static 
         */ 
        public static function getLogger($log_type)
        {
                        /** @var \Newhouse\Log\Logger $instance */
                        return $instance->getLogger($log_type);
        }
